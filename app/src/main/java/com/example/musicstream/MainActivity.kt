...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getCategories()
        setupSection("secion_1",binding.section1MainLayout,binding.session1Title,binding.session1RecyclerView)
        setupSection("secion_2",binding.section2MainLayout,binding.session2Title,binding.session2RecyclerView)
        setupSection("secion_3",binding.section3MainLayout,binding.session3Title,binding.session3RecyclerView)
    ...
    fun showPopupMenu(){
        ...
        val infator = popupMenu.menuInflater
        infator.inflate(R.menu.option_menu,popupMenu.menu)
        popupMenu.show()
        popupMenu.setOnMenuItemClickListener {
            when(it.itemId){
                ...
                R.id.find_music_op -> {
                    val intent =Intent(this, FindMusicActivity::class.java)
    ...
    fun logout(){
        MyExoplayer.getInsance()?.release()
